...
export default function Sidebar({handleClick, state, container}){
    return(
        <div className="sidebar">
            ...
            <section className='sidebar__content' ref={container} sx={{
            position: 'fixed',
            top: 0,
            left: 0,
            zIndex: 10,
            ...
            <div sx={{
                ...
                <FontAwesomeIcon icon={ faTimes } onClick={handleClick} sx={{
                fontSize: '2rem',
                color: 'white',
                display: 'block',
            ...
            <ul sx ={{
                ...
                <SidebarLink text="Courses" link='https://school.thecaribbeanscholar.com/' isInternal={false}/>
            </ul>

            <div className='sidebar__ad' sx={{
                marginBottom: '1.5rem'
            }}>
                <div
                className='sidebar__ad__image-container' sx={{
                    margin: '0 24px'
                }}>
