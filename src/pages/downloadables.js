...
export default function Downloadables() {
    ...
    return(
        <div>
            <SEO title='Free Online CXC Downloadables | Caribbean Scholar' 
                excerpt='Gifts for you! Crafty downloadable materials to help you along with your exam
                preparations'/>
             <MainHeader />
             <HomeHero copy='Downloadables' alt='Online CSEC Math Book' tagline='Extra materials for you to read, download and enjoy'
